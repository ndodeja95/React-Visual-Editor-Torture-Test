# Consuming React Visual Editor Lab Design System in web apps

Read `artifacts/react-visual-editor-lab-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/react-visual-editor-lab-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/react-visual-editor-lab-ds/styles.css";
```
...
`node_modules/@workspace/react-visual-editor-lab-ds/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/react-visual-editor-lab-ds/components/ui/button";
import { cn } from "@workspace/react-visual-editor-lab-ds/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/react-visual-editor-lab-ds/hooks/use-toast";
```
...
`@workspace/react-visual-editor-lab-ds/components/ui/button`. Run the app's typecheck
