# React Visual Editor Lab Design System design system
...
workspace package (`@workspace/react-visual-editor-lab-ds`): other artifacts depend
...
- `docs/references/component-inventory.md` — the extracted source-backed
  primitive inventory and build plan.
- `docs/references/components/` — evidence and usage contracts for each extracted
  primitive. Read the relevant contract before changing that primitive.
...
This system was extracted from the existing React Visual Editor Torture Test
artifact. The source does not ship a separate component library; the inventory
therefore captures the reusable visual primitives evidenced by its `App.tsx`
and `index.css`: LabButton, LabCard, LabInput, SourceChip, and StatusDot.
Application-specific navigation, state, fixture content, and animations remain
in the consuming lab rather than being copied into this package.
...
`@workspace/react-visual-editor-lab-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/react-visual-editor-lab-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/react-visual-editor-lab-ds` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/react-visual-editor-lab-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/react-visual-editor-lab-ds/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/react-visual-editor-lab-ds/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/react-visual-editor-lab-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/react-visual-editor-lab-ds/docs/migrating-expo.md`
