# Migrating web UI to React Visual Editor Lab Design System

Read `artifacts/react-visual-editor-lab-ds/docs/AGENTS.md` and
`artifacts/react-visual-editor-lab-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/react-visual-editor-lab-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/react-visual-editor-lab-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/react-visual-editor-lab-ds/hooks/use-toast`
