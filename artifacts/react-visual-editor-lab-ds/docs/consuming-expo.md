# Consuming React Visual Editor Lab Design System in Expo apps

Read `artifacts/react-visual-editor-lab-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/react-visual-editor-lab-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/react-visual-editor-lab-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/react-visual-editor-lab-ds/lib/native-theme";
import { useColors } from "@workspace/react-visual-editor-lab-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/react-visual-editor-lab-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/react-visual-editor-lab-ds/components/native/badge";
import { Button } from "@workspace/react-visual-editor-lab-ds/components/native/button";
import { Card } from "@workspace/react-visual-editor-lab-ds/components/native/card";
```
...
Import and render
`@workspace/react-visual-editor-lab-ds/components/native/button`, then run Expo
