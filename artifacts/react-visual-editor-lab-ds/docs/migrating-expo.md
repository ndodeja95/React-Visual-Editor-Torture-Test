# Migrating Expo UI to React Visual Editor Lab Design System

Read `artifacts/react-visual-editor-lab-ds/docs/AGENTS.md` and
`artifacts/react-visual-editor-lab-ds/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/react-visual-editor-lab-ds/lib/native-theme` and
  `@workspace/react-visual-editor-lab-ds/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/react-visual-editor-lab-ds/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/react-visual-editor-lab-ds` and retains only
