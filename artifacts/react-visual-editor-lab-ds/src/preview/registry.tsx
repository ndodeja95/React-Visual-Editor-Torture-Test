...
const LabButtonDemo = lazyPage(() =>
  import('./demos/lab-button').then(({ LabButtonDemo }) => LabButtonDemo),
);
const LabCardDemo = lazyPage(() =>
  import('./demos/lab-card').then(({ LabCardDemo }) => LabCardDemo),
);
const LabInputDemo = lazyPage(() =>
  import('./demos/lab-input').then(({ LabInputDemo }) => LabInputDemo),
);
const SourceChipDemo = lazyPage(() =>
  import('./demos/source-chip').then(({ SourceChipDemo }) => SourceChipDemo),
);
const StatusDotDemo = lazyPage(() =>
  import('./demos/status-dot').then(({ StatusDotDemo }) => StatusDotDemo),
);
...
export const DESIGN_SYSTEM = {
  title: 'React Visual Editor Lab Design System',
  description:
    'Dark-first primitives for source-mapping labs, documentation shells, and editor-friendly test fixtures.',
} as const;
    ...
    entries: [
      {
        id: 'lab-button',
        name: 'Lab button',
        description: 'Compact actions with default, primary, ghost, and disabled states.',
        Page: LabButtonDemo,
      },
      {
        id: 'lab-card',
        name: 'Lab card',
        description: 'Bounded source-mapping surfaces with an accent edge and target well.',
        Page: LabCardDemo,
      },
      {
        id: 'lab-input',
        name: 'Lab input',
        description: 'Compact, full-width inputs with explicit focus treatment.',
        Page: LabInputDemo,
      },
      {
        id: 'source-chip',
        name: 'Source chip',
        description: 'Monospace metadata labels for source patterns and fixture IDs.',
        Page: SourceChipDemo,
      },
      {
        id: 'status-dot',
        name: 'Status dot',
        description: 'Tiny live and inactive runtime indicators.',
        Page: StatusDotDemo,
      },
    ],
  },
