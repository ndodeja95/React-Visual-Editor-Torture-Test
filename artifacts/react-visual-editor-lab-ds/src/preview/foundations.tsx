...
export function OverviewPage() {
  return (
    <div className="space-y-4">
      <section className="ds-grid-paper rounded-xl border bg-card p-5 text-card-foreground">
        <div className="ds-eyebrow">Extracted visual language</div>
        <h2 className="mt-2 text-2xl font-bold tracking-[-.04em]">
          Break the interface before users do.
        </h2>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
          A technical, source-aware system for documentation shells, compatibility
          labs, and interactive fixtures where every boundary should be visible.
        </p>
        <div className="mt-5 border-t pt-4">
          <Guidelines
            items={[
              { kind: 'do', text: 'Use monospace for IDs, source patterns, and runtime metadata.' },
              { kind: 'do', text: 'Keep target surfaces bounded with dashed borders and compact spacing.' },
              { kind: 'dont', text: 'Hide interactive states behind low-contrast surfaces or ambiguous hit areas.' },
            ]}
          />
        </div>
      </section>
