...
type CatalogItem = {
  ...
  category: string;
  pattern: string;
  expected: 'Direct edit' | 'Fallback' | 'All instances' | 'Selection only';
  filters: FilterMode[];
  instruction: string;
};
...
function AppShell() {
  ...
  const reset = () => {
    ...
    setControlled('editable signal'); setUncontrolledRead('No read yet'); setSubmitted('Awaiting submit');
